    ...
    <main>
        ...
        <div class="content">
            <form class="form" method="POST"
                  action="${pageContext.request.contextPath}/controller?command=decimation-cipher-resolve">
                ...
                <input type="number" name="shift" class="shift" placeholder="Enter key here" value="${shift}" required>
                <div class="buttons">
